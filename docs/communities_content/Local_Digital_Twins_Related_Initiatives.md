...
![DUET Project Logo](../assets/duet_logo.png){ width="130" align="center" }  
---  

**Short Description:**  
DUET (Digital Urban European Twins) is a European innovation initiative that leverages cloud technology, sensor data, and advanced analytics to create virtual city replicas. These Digital Twins enable cities and regions to better understand the complex interactions between urban factors such as traffic, air quality, and noise. By simulating and visualizing different scenarios, DUET empowers policymakers to make more evidence-based operational decisions and long-term policy choices, ensuring that public sector decision-making is more democratic, effective, and future-proof.  

DUET is developed and tested in Flanders (Belgium), Pilsen (Czechia), and Athens (Greece)—three pilots representing different levels of digital maturity. The project demonstrates how digital twins can be adapted to diverse city contexts and scaled across Europe, providing Policy-Ready Data as a Service (PRDaaS) to support sustainable urban transformation.  

**Key role in the LDT Ecosystem:**  
DUET acts as a pioneer reference project for applying Local Digital Twins in public governance. It plays a vital role in the LDT ecosystem by:  
- Delivering virtual city replicas for systemic policy exploration and experimentation.  
- Enabling evidence-based, real-time decision-making for urban challenges (e.g., traffic congestion, pollution, emergency response).  
- Demonstrating cross-sector interoperability and data integration (IoT, GIS, mobility, environment).  
- Providing cost-effective, adaptable solutions that cities can adopt according to their digital maturity and strategy.  
- Embedding AI and ML functions to forecast urban dynamics and infrastructure performance.  

**Relevance to LDT4SSC:**  
DUET contributes to LDT4SSC goals by:  
- Showcasing pilots in three European cities, demonstrating scalability and replicability across different governance contexts.  
- Policy-Ready Data as a Service (PRDaaS): Offering cities ready-to-use data services for better policy design and implementation.  
- Supporting decision-makers: Providing user-friendly dashboards for policy simulation, foresight, and emergency coordination.  
- Integrating interoperability principles: Aligning with EU digital twin frameworks, standards, and cross-sector use cases.  

**Key Assets and Resources:**  
[[Technology Outputs](https://www.digitalurbantwins.com/technology-outputs), [Research Outputs](https://www.digitalurbantwins.com/research-outputs), [City Twin Platform Demo](https://www.digitalurbantwins.com/digitaltwindemo), [Policy-Making Outputs](https://www.digitalurbantwins.com/policy-making-outputs)] 

**Webpage / Reference Link:**  
[https://www.digitalurbantwins.com](https://www.digitalurbantwins.com)  

**Main contact point:**  
[DUET Contact Page](https://www.digitalurbantwins.com/contact-8)  
