...
-   :material-database:{ .lg .middle } __Data Spaces__  
    ...
    [:octicons-arrow-right-24: View Details](Data_Spaces_Related_Initiatives.md)
...
-   :material-robot-excited:{ .lg .middle } __AI for Smart Cities__  
    ...
    [:octicons-arrow-right-24: View Details](AI_For_Smart_Cities_Related_Initiatives.md)
...
-   :material-city-variant-outline:{ .lg .middle } __Local Digital Twins (LDTs)__  
    ...
    [:octicons-arrow-right-24: View Details](Local_Digital_Twins_Related_Initiatives.md)
...
-   :material-earth:{ .lg .middle } __CitiVERSE__  
    ...
    [:octicons-arrow-right-24: View Details](CitiVerse_Related_Initiatives.md)
...
-   :material-lan:{ .lg .middle } __Interoperability & MIMs__  
    ...
    [:octicons-arrow-right-24: View Details](Interoperability_and_MIMs_Related_Initiatives.md)
...
-   :material-city:{ .lg .middle } __Cities Network & Supporting Actions__  
    ...
    [:octicons-arrow-right-24: View Details](Cities_Network_Related_Initiatives.md)
