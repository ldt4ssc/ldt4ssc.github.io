...
!!! tip "On this page"
    ...
    - [Guidance on AI](#guidance-on-ai) - Guidance specific for AI-based services
...
!!! info "Guidance on AI"
    [Go to the AI Guidance page :octicons-arrow-right-24:](ai_guidance.md){ .md-button .md-button--primary }
...
| **French Government** [Accessibility Inspection Grid](../assets/XLSs/blank_quick-accessibility-inspection-grid_2025.xlsx) | Quick Accessibility Inspection Grid | Accessibility |
